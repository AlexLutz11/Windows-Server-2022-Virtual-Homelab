...
The server is configured to communicate with a Windows 11 client VM over an isolated internal network. The goal is to simulate a real-world domain environment for learning and testing purposes.
